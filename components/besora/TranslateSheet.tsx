  ...
  return (
    <div style={{ borderRadius: 16, border: `1px solid ${theme.cardBorder}`, background: theme.card, padding: 12 }}>
      <div style={{ marginBottom: 8, display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: theme.textMuted }}>
        <span style={{ borderRadius: 999, background: "rgba(13,52,84,0.08)", padding: "2px 8px", color: theme.text }}>{fromName}</span>
        <span>→</span>
      ...
      {out && (
        <div style={{ marginTop: 8, display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8, borderRadius: 12, background: "#f2f7fb", padding: "8px 12px" }}>
