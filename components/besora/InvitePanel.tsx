...
export default function InvitePanel() {
  ...
  return (
    <div style={{ borderRadius: 16, border: `1px solid ${theme.cardBorder}`, background: theme.card, padding: 16, textAlign: "center" }}>
      <p style={{ margin: "0 0 12px", fontSize: 13, color: theme.textMuted, lineHeight: 1.55 }}>{ui(myLang, "inviteReady")}</p>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src={qr} alt="QR" width={180} height={180} style={{ borderRadius: 12, background: "#fff", padding: 6 }} />
