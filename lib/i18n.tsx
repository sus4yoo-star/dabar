...
export function LangSelector() {
  ...
  return (
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && (
        <div role="listbox" style={{ position: "absolute", top: "calc(100% + 6px)", right: 0, zIndex: 50, minWidth: 150, maxHeight: 264, overflowY: "auto", background: "#fff", border: "1px solid rgba(13,52,84,0.15)", borderRadius: 14, boxShadow: "0 12px 32px rgba(23,50,73,0.18)", padding: 4 }}>
          {LANGS.map(l => {
