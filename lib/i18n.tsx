...
const DICT: Dict = {
  ...
  "common.edit":      { ko: "수정", en: "Edit", th: "แก้ไข", lo: "ແກ້ໄຂ" },
  ...
  "disp.bigTextSub":  { ko: "글씨를 키워 더 편하게 봐요", en: "Bigger text, easier to read", th: "ขยายตัวอักษรให้อ่านง่าย", lo: "ຂະຫຍາຍໂຕໜັງສືໃຫ້ອ່ານງ່າຍ" },
  "disp.night":       { ko: "야간 모드", en: "Night mode", th: "โหมดกลางคืน", lo: "ໂໝດກາງຄືນ" },
  "disp.nightSub":    { ko: "어두운 화면으로 눈을 편하게", en: "Dark screen, easier on the eyes", th: "หน้าจอมืดสบายตา", lo: "ໜ້າຈໍມືດສະບາຍຕາ" },
  ...
  "sos.addContact": { ko: "＋ 동행 추가", en: "＋ Add companion", th: "＋ เพิ่มเพื่อน", lo: "＋ ເພີ່ມເພື່ອນ" },
  "sos.namePh":     { ko: "이름(선택)", en: "Name (optional)", th: "ชื่อ (ไม่บังคับ)", lo: "ຊື່ (ບໍ່ບັງຄັບ)" },
  "sos.phonePh":    { ko: "전화번호", en: "Phone number", th: "เบอร์โทร", lo: "ເບີໂທ" },
  "sos.locTitle":   { ko: "내 위치 (선택)", en: "My location (optional)", th: "ตำแหน่งของฉัน (ไม่บังคับ)", lo: "ຕຳແໜ່ງຂອງຂ້ອຍ (ບໍ່ບັງຄັບ)" },
  "sos.locNote":    { ko: "(대략적인 GPS)가 메시지에 함께 전송됩니다", en: "(approximate GPS) is included in the message", th: "(GPS โดยประมาณ) จะถูกแนบไปกับข้อความ", lo: "(GPS ໂດຍປະມານ) ຈะຖືກແນບໄປກັບຂໍ້ຄວາມ" },
  "sos.savedHint":  { ko: "입력하면 자동 저장돼요 ✓", en: "Saved automatically ✓", th: "บันทึกอัตโนมัติ ✓", lo: "ບັນທຶກອັດຕະໂນມັດ ✓" },
  "sos.kakao":      { ko: "💬 카카오톡·단톡방으로 보내기", en: "💬 Send via KakaoTalk", th: "💬 ส่งผ่าน KakaoTalk", lo: "💬 ສົ່ງຜ່ານ KakaoTalk" },
  "sos.copied":     { ko: "메시지를 복사했어요. 단톡방에 붙여넣어 보내세요.", en: "Message copied — paste into your group chat.", th: "คัดลอกข้อความแล้ว วางในแชทกลุ่ม", lo: "ສຳເນົາຂໍ້ຄວາມແລ້ວ" },
  "sos.smsNote":    { ko: "💡 한국 번호는 국제문자가 안 갈 수 있어요 — 카톡을 먼저 쓰세요", en: "💡 Korean numbers may not get international SMS — use KakaoTalk first", th: "💡 เบอร์เกาหลีอาจไม่ได้รับ SMS — ใช้ KakaoTalk ก่อน", lo: "💡 ໃຊ້ KakaoTalk ກ່ອນ" },
  ...
  "sos.situation": { ko: "현재 상황 (선택)", en: "Current situation (optional)", th: "สถานการณ์ตอนนี้ (ไม่บังคับ)", lo: "ສະຖານະການຕອນນີ້ (ບໍ່ບັງຄັບ)" },
  "sos.situationPh": { ko: "예: 길을 잃었어요 / 몸이 아파요 / 사고가 났어요", en: "e.g. I'm lost / I'm hurt / accident", th: "เช่น หลงทาง / บาดเจ็บ / อุบัติเหตุ", lo: "ເຊັ່ນ ຫຼົງທາງ / ບາດເຈັບ / ອຸບັດຕິເຫດ" },
  "sos.situationHint": { ko: "너무 위급하면 적지 말고 바로 SOS부터 보내세요 🚨", en: "If it's very urgent, skip this and send SOS first 🚨", th: "ถ้าเร่งด่วนมาก ข้ามไปและส่ง SOS ก่อน 🚨", lo: "ຖ້າຮີບດ່ວນຫຼາຍ ສົ່ງ SOS ກ່ອນ 🚨" },
  ...
  "conn.contact":     { ko: "연락처 (전화·카카오ID·이메일 등)", en: "Contact (phone, Kakao ID, email…)", th: "ช่องทางติดต่อ (โทรศัพท์ · Line · อีเมล)", lo: "ຊ່ອງທາງຕິດຕໍ່ (ໂທລະສັບ · WhatsApp · ອີເມວ)" },
  "conn.region":      { ko: "사는 지역 (예: 서울 강서구 / 치앙마이)", en: "Your area (e.g. Bangkok, Chiang Mai)", th: "พื้นที่ที่อาศัย (เช่น กรุงเทพฯ เขตบางนา)", lo: "ເຂດທີ່ອາໄສ (ເຊັ່ນ ວຽງຈັນ)" },
  "conn.note":        { ko: "하고 싶은 말 (선택)", en: "Anything you'd like to share (optional)", th: "สิ่งที่อยากบอก (ไม่บังคับ)", lo: "ສິ່ງທີ່ຢາກບອກ (ບໍ່ບັງຄັບ)" },
  "conn.privacy":     { ko: "남겨주신 정보는 교회 소개 목적에만 사용하고, 완료 후 파기합니다.", en: "Your details are used only to introduce a church, then deleted.", th: "ข้อมูลของคุณใช้เพื่อแนะนำคริสตจักรเท่านั้น และจะถูกลบหลังเสร็จสิ้น", lo: "ຂໍ້ມູນຂອງເຈົ້າໃຊ້ເພື່ອແນະນຳຄຣິສຕະຈັກເທົ່ານັ້ນ ແລະຈະຖືກລຶບຫຼັງສຳເລັດ" },
  "conn.submit":      { ko: "연결 요청 보내기", en: "Send request", th: "ส่งคำขอ", lo: "ສົ່ງຄຳຂໍ" },
  "conn.sending":     { ko: "보내는 중...", en: "Sending...", th: "กำลังส่ง...", lo: "ກຳລັງສົ່ງ..." },
  "conn.doneTitle":   { ko: "요청이 접수됐어요 🙏", en: "Request received 🙏", th: "ได้รับคำขอแล้ว 🙏", lo: "ໄດ້ຮັບຄຳຂໍແລ້ວ 🙏" },
  "conn.doneBody":    { ko: "남겨주신 연락처로 곧 연락드릴게요. 신뢰할 수 있는 교회를 정성껏 찾아 소개해 드리겠습니다.", en: "We'll reach out soon. We'll carefully find and introduce a trusted church for you.", th: "เราจะติดต่อกลับเร็ว ๆ นี้ และตั้งใจหาคริสตจักรที่ไว้ใจได้ให้คุณ", lo: "ພວກເຮົາຈະຕິດຕໍ່ກັບໄວໆນີ້ ແລະຕັ້ງໃຈຊອກຄຣິສຕະຈັກທີ່ໄວ້ໃຈໄດ້ໃຫ້ເຈົ້າ" },
  "conn.fail":        { ko: "전송에 실패했어요. 잠시 후 다시 시도해 주세요.", en: "Failed to send. Please try again shortly.", th: "ส่งไม่สำเร็จ กรุณาลองใหม่", lo: "ສົ່ງບໍ່ສຳເລັດ ກະລຸນາລອງໃໝ່" },
  "conn.required":    { ko: "이름·연락처·지역을 모두 입력해 주세요.", en: "Please fill in name, contact, and area.", th: "กรุณากรอกชื่อ ช่องทางติดต่อ และพื้นที่", lo: "ກະລຸນາໃສ່ຊື່ ຊ່ອງທາງຕິດຕໍ່ ແລະເຂດ" },
  "conn.adTitle":     { ko: "⛪ 교회 연결 요청", en: "⛪ Church connection requests", th: "⛪ คำขอเชื่อมต่อคริสตจักร", lo: "⛪ ຄຳຂໍເຊື່ອມຕໍ່ຄຣິສຕະຈັກ" },
  "conn.adEmpty":     { ko: "아직 요청이 없어요.", en: "No requests yet.", th: "ยังไม่มีคำขอ", lo: "ຍັງບໍ່ມີຄຳຂໍ" },
  "conn.stPending":   { ko: "대기중", en: "Pending", th: "รอดำเนินการ", lo: "ລໍຖ້າ" },
  "conn.stContacted": { ko: "연락함", en: "Contacted", th: "ติดต่อแล้ว", lo: "ຕິດຕໍ່ແລ້ວ" },
  ...
  "login.emailSent":  { ko: "✉️ 메일로 보낸 코드를 입력하세요. (스팸함도 확인)", en: "✉️ Enter the code we emailed you. (Check spam too)", th: "✉️ กรอกรหัสที่เราส่งไปทางอีเมล (ตรวจสแปมด้วย)", lo: "✉️ ໃສ່ລະຫັດທີ່ສົ່ງໄປທາງອີເມວ (ກວດສະແปมด้วย)" },
  "login.codePh":     { ko: "인증 코드", en: "Verification code", th: "รหัสยืนยัน", lo: "ລະຫັດຢືนຢັน" },
  ...
  "grp.invite":    { ko: "💬 카카오톡으로 초대하기", en: "💬 Invite via KakaoTalk", th: "💬 เชิญผ่าน KakaoTalk", lo: "💬 ເຊີນຜ່ານ KakaoTalk" },
  "grp.inviteTitle": { ko: "소그룹에 초대합니다 🤝", en: "invites you to this small group 🤝", th: "เชิญเข้ากลุ่มย่อย 🤝", lo: "ເຊີນເຂົ້າກຸ່ມຍ່ອຍ 🤝" },
  "grp.inviteJoin": { ko: "참여하기", en: "Join", th: "เข้าร่วม", lo: "ເຂົ້າຮ່ວມ" },
  "grp.inviteCopied": { ko: "초대 링크를 복사했어요. 카톡에 붙여넣어 보내세요.", en: "Invite link copied — paste into KakaoTalk.", th: "คัดลอกลิงก์เชิญแล้ว วางใน KakaoTalk", lo: "ສຳເນົາລິ້ງເຊີນແລ້ວ ວາງໃນ KakaoTalk" },
  "grp.makePrivate": { ko: "🔒 비공개로 전환", en: "🔒 Make private", th: "🔒 ตั้งเป็นส่วนตัว", lo: "🔒 ຕັ້ງເປັນສ່ວນຕົວ" },
  "grp.makePublic":  { ko: "🌐 공개로 전환", en: "🌐 Make public", th: "🌐 ตั้งเป็นสาธารณะ", lo: "🌐 ຕັ້ງເປັນສາທາລະນະ" },
  "grp.private":     { ko: "비공개 모임", en: "Private group", th: "กลุ่มส่วนตัว", lo: "ກຸ່ມສ່ວນຕົວ" },
  "grp.deleteGroup": { ko: "🗑 모임 삭제", en: "🗑 Delete group", th: "🗑 ลบกลุ่ม", lo: "🗑 ລຶບກຸ່ມ" },
  "grp.delGroupConfirm": { ko: "이 모임을 삭제할까요? 채팅·사진·참여자가 모두 사라지고 되돌릴 수 없어요.", en: "Delete this group? Chat, photos and members will be removed permanently.", th: "ลบกลุ่มนี้? แชท รูป สมาชิกจะหายถาวร", lo: "ລຶບກຸ່ມນີ້? ແຊັດ ຮູບ ສະມາຊິກຈະຫາຍຖາວອນ" },
  "grp.visChanged":  { ko: "공개 설정을 변경했어요.", en: "Visibility updated.", th: "อัปเดตการมองเห็นแล้ว", lo: "ອັບເດດການເບິ່ງເຫັນແລ້ວ" },
  ...
  "reach.next":    { ko: "다음 할 일", en: "Next action", th: "สิ่งที่จะทำต่อ", lo: "ສິ່ງທີ່ຈະເຮັດ" },
  "reach.nextPh":  { ko: "예: 점심 약속 / 교회 초대 / 안부 연락", en: "e.g. lunch, invite to church, check in", th: "เช่น นัดทานข้าว เชิญไปโบสถ์", lo: "ເຊັ່ນ ນັດກິນເຂົ້າ ເຊີນໄປໂບດ" },
  "reach.setDate": { ko: "날짜", en: "Date", th: "วันที่", lo: "ວັນທີ" },
  "reach.today":   { ko: "오늘", en: "Today", th: "วันนี้", lo: "ມື້ນີ້" },
  "reach.overdue": { ko: "지남", en: "Overdue", th: "เลยกำหนด", lo: "ກາຍກຳນົດ" },
  "reach.phonePh": { ko: "연락처(선택)", en: "Phone (optional)", th: "เบอร์ (ไม่บังคับ)", lo: "ເບີ (ບໍ່ບັງຄັບ)" },
  "reach.share":   { ko: "📤 전하기", en: "📤 Share", th: "📤 แชร์", lo: "📤 ແບ່ງປັນ" },
  "reach.shareText": { ko: "{name}님께 다바르를 전합니다 🕊️ 함께 말씀과 함께해요:", en: "Sharing DABAR with you 🕊️ Walk with the Word together:", th: "ขอแบ่งปัน DABAR 🕊️", lo: "ຂໍແບ່ງປັນ DABAR 🕊️" },
  "reach.copied":  { ko: "복사했어요. 카톡 등에 붙여넣어 보내세요.", en: "Copied — paste into KakaoTalk etc.", th: "คัดลอกแล้ว", lo: "ສຳເນົາແລ້ວ" },
  "reach.pray":    { ko: "🙏 소그룹 기도", en: "🙏 Group prayer", th: "🙏 อธิษฐานกลุ่ม", lo: "🙏 ອະທິຖານກຸ່ມ" },
  "reach.pickGroup": { ko: "어느 소그룹에 기도 나눌까요?", en: "Share to which group?", th: "แชร์ไปกลุ่มไหน?", lo: "ແບ່ງປັນໄປກຸ່ມໃດ?" },
  "reach.prayPosted": { ko: "소그룹에 기도 나눔을 보냈어요 🙏", en: "Shared to the group 🙏", th: "แชร์ไปกลุ่มแล้ว 🙏", lo: "ແບ່ງປັນໄປກຸ່ມແລ້ວ 🙏" },
  "reach.noGroups":   { ko: "참여한 소그룹이 없어요.", en: "You're not in any group.", th: "ยังไม่ได้อยู่ในกลุ่ม", lo: "ຍັງບໍ່ຢູ່ໃນກຸ່ມ" },
  "reach.prayMsg":    { ko: "🙏 전도 기도 부탁드려요", en: "🙏 Please pray for outreach", th: "🙏 ช่วยอธิษฐาน", lo: "🙏 ຊ່ວຍອະທິຖານ" },
  "reach.fromContacts": { ko: "📇 연락처에서", en: "📇 From contacts", th: "📇 จากรายชื่อ", lo: "📇 ຈາກລາຍຊື່" },
  "home.reachToday":  { ko: "오늘 챙길 {n}명", en: "{n} to follow up today", th: "ติดตามวันนี้ {n}", lo: "ຕິດຕາມມື້ນີ້ {n}" },

  // 사역 허브 — 일정 / 공지 / (환율·번역은 별도 컴포넌트)
  "min.schedule":  { ko: "📅 사역 일정", en: "📅 Ministry Schedule", th: "📅 ตารางพันธกิจ", lo: "📅 ຕາຕະລາງພັນທະກິດ" },
  "min.notices":   { ko: "📢 사역 공지사항", en: "📢 Ministry Notices", th: "📢 ประกาศพันธกิจ", lo: "📢 ແຈ້ງການພັນທະກິດ" },
  "min.outreachTitle": { ko: "🌱 전도 여정 — 내가 전하는 사람들", en: "🌱 Outreach — people I'm reaching", th: "🌱 เส้นทางประกาศ — คนที่ฉันประกาศ", lo: "🌱 ເສັ້ນທາງປະກາດ — ຄົນທີ່ຂ້ອຍປະກາດ" },
  "min.addEvent":  { ko: "＋ 일정", en: "＋ Event", th: "＋ ตาราง", lo: "＋ ຕາຕະລາງ" },
  "min.addNotice": { ko: "＋ 공지", en: "＋ Notice", th: "＋ ประกาศ", lo: "＋ ແຈ້ງການ" },
  "min.titlePh":   { ko: "제목", en: "Title", th: "หัวข้อ", lo: "ຫົວຂໍ້" },
  "min.placePh":   { ko: "장소 (선택)", en: "Place (optional)", th: "สถานที่ (ไม่บังคับ)", lo: "ສະຖານທີ່ (ບໍ່ບັງຄັບ)" },
  "min.eventNotePh": { ko: "메모 (선택)", en: "Note (optional)", th: "บันทึก (ไม่บังคับ)", lo: "ບັນທຶກ (ບໍ່ບັງຄັບ)" },
  "min.bodyPh":    { ko: "내용", en: "Details", th: "รายละเอียด", lo: "ລາຍລະອຽດ" },
  "min.noEvents":  { ko: "예정된 사역 일정이 없어요.", en: "No upcoming events.", th: "ยังไม่มีตารางที่จะถึง", lo: "ຍັງບໍ່ມີຕາຕະລາງທີ່ຈະມາ" },
  "min.noNotices": { ko: "등록된 공지가 없어요.", en: "No notices yet.", th: "ยังไม่มีประกาศ", lo: "ຍັງບໍ່ມີແຈ້ງການ" },
  "min.delConfirm":{ ko: "삭제할까요?", en: "Delete?", th: "ลบ?", lo: "ລຶບ?" },
  "min.notReady":  { ko: "DB 설정(besora-ministry.sql)이 필요해요.", en: "DB setup (besora-ministry.sql) required.", th: "ต้องตั้งค่าฐานข้อมูล (besora-ministry.sql)", lo: "ຕ້ອງຕັ້ງຄ່າຖານຂໍ້ມູນ (besora-ministry.sql)" },
