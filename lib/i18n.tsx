...
const DICT: Dict = {
  ...
  "sos.locTitle":   { ko: "내 위치", en: "My location", th: "ตำแหน่งของฉัน", lo: "ຕຳແໜ່ງຂອງຂ້ອຍ" },
  "sos.locNote":    { ko: "📍 내 위치(대략적인 GPS)가 메시지에 함께 전송됩니다", en: "📍 Your approximate GPS location is included", th: "📍 ตำแหน่ง GPS โดยประมาณจะถูกแนบไป", lo: "📍 ຕຳແໜ່ງ GPS ໂດຍປະມານຈะຖືກແນບໄປ" },
