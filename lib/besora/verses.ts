...
//  키: 정규화된 "BOOK 장:절" (예: "JHN 3:16"). 언어: ko / en / th
// =====================================================================

type Tri = { ko: string; en: string; th: string };

// 책 약어 → 언어별 책 이름(라벨용)
const BOOK_NAMES: Record<string, Tri> = {
  GEN: { ko: "창세기", en: "Genesis", th: "ปฐมกาล" },
  ISA: { ko: "이사야", en: "Isaiah", th: "อิสยาห์" },
  MRK: { ko: "마가복음", en: "Mark", th: "มาระโก" },
  JHN: { ko: "요한복음", en: "John", th: "ยอห์น" },
  ROM: { ko: "로마서", en: "Romans", th: "โรม" },
  REV: { ko: "요한계시록", en: "Revelation", th: "วิวรณ์" },
  "2CO": { ko: "고린도후서", en: "2 Corinthians", th: "2 โครินธ์" },
  "1PE": { ko: "베드로전서", en: "1 Peter", th: "1 เปโตร" },
  "2PE": { ko: "베드로후서", en: "2 Peter", th: "2 เปโตร" },
};

// 책 이름(여러 언어 표기) → 약어. 검색은 소문자 substring 으로 한다.
const BOOK_ALIASES: { alias: string; code: string }[] = [
  { alias: "창세기", code: "GEN" }, { alias: "genesis", code: "GEN" }, { alias: "ปฐมกาล", code: "GEN" },
  { alias: "이사야", code: "ISA" }, { alias: "isaiah", code: "ISA" }, { alias: "อิสยาห์", code: "ISA" },
  { alias: "마가복음", code: "MRK" }, { alias: "마가", code: "MRK" }, { alias: "mark", code: "MRK" }, { alias: "มาระโก", code: "MRK" },
  // 요한계시록을 요한복음보다 먼저 검사 (substring 충돌 방지)
  { alias: "요한계시록", code: "REV" }, { alias: "계시록", code: "REV" }, { alias: "revelation", code: "REV" }, { alias: "วิวรณ์", code: "REV" },
  { alias: "요한복음", code: "JHN" }, { alias: "john", code: "JHN" }, { alias: "ยอห์น", code: "JHN" },
  { alias: "로마서", code: "ROM" }, { alias: "로마", code: "ROM" }, { alias: "romans", code: "ROM" }, { alias: "โรม", code: "ROM" },
  { alias: "고린도후서", code: "2CO" }, { alias: "2 corinthians", code: "2CO" }, { alias: "2corinthians", code: "2CO" }, { alias: "โครินธ์", code: "2CO" },
  { alias: "베드로후서", code: "2PE" }, { alias: "2 peter", code: "2PE" }, { alias: "2peter", code: "2PE" }, { alias: "2 เปโตร", code: "2PE" }, { alias: "2เปโตร", code: "2PE" },
  { alias: "베드로전서", code: "1PE" }, { alias: "1 peter", code: "1PE" }, { alias: "1peter", code: "1PE" }, { alias: "เปโตร", code: "1PE" },
];

// 말씀 본문 (개역개정 계열 / 한글·영문·태국어)
...
export function versesFor(ref: string | null | undefined, lang: string): VersePassage[] {
  if (!ref) return [];
  const L = (lang === "en" || lang === "th") ? lang : "ko";
  ...
  for (const seg of segments) {
    ...
    const bn = BOOK_NAMES[currentBook]?.[L as "ko" | "en" | "th"] ?? currentBook;
    out.push({ key, label: `${bn} ${m[1]}:${m[2]}`, text: v[L as "ko" | "en" | "th"] });
  }
  return out;
}
