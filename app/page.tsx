...
export default function Home() {
  ...
  return (
    <main style={{ maxWidth: 440, margin: "0 auto", padding: "1.5rem 1.1rem 2rem", minHeight: "100dvh" }}>
      {/* 상단 바 */}
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 6, rowGap: 8, flexWrap: "wrap", marginBottom: "1.6rem" }}>
        <div style={{ display: "flex", gap: 5, flexShrink: 0, flexWrap: "wrap" }}>
          ...
          <button onClick={() => router.push("/groups")} style={{ fontSize: 12.5, fontWeight: 700, color: theme.primarySoft, background: theme.primaryBg, border: `1px solid ${theme.cardBorder}`, borderRadius: 18, padding: "6px 9px", cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0 }}>{t("common.groups")}</button>
