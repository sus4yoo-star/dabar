        ...
        <div className="fade-in" style={{ textAlign: "center", paddingTop: "1.5rem" }}>
          ...
          {nextLesson ? (
            <button onClick={() => { setPhase("learn"); setQIdx(0); setSelected(null); setCorrectCount(0); router.push(`/course/${course.slug}/${nextLesson.id}`); }}
              style={{ width: "100%", padding: 16, fontSize: 16, fontWeight: 800, background: "linear-gradient(135deg,#a6e02f 0%,#86c40a 100%)", color: "#08263a", border: "none", borderRadius: 14, cursor: "pointer", marginBottom: 10, boxShadow: "0 8px 20px rgba(88,167,0,0.20)" }}>{t("co.nextLesson")}</button>
          ) : (
