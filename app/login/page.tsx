...
export default function LoginPage() {
  ...
  return (
    <main style={{ maxWidth: 420, margin: "0 auto", padding: "4rem 1.5rem", textAlign: "center" }}>
      ...
      <p style={{ fontSize: 14, color: theme.textMuted, margin: "0 0 3rem" }}>카카오 또는 구글로 로그인하고 다바르를 시작하세요</p>
      ...
      <p style={{ fontSize: 12, color: theme.textMuted, marginTop: 28, lineHeight: 1.6 }}>
        로그인하면 점수가 기록되고<br />랭킹에 도전할 수 있어요
      </p>
